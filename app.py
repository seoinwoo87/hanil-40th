...
with st.sidebar:
    ...
    sel_num = sel_student.split(" ")[0] if sel_student else ""
        ...
        if not filtered.empty:
            if exam == "학기말":
                ...
                for _, row in filtered.iterrows():
                    ...
                    plot_data.append({'과목': row['과목'], '점수': my_score, '중위값': median_val, '백분위': calc_perc})
...
# ==========================================
# 6. 모의고사 분석 (표점/등급 소수점 X, 백분위 소수점 O)
# ==========================================
elif menu == "🎯 모의고사 분석":
